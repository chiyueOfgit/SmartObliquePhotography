...
namespace hiveObliquePhotography
{
	namespace AutoRetouch
	{
		...
		public:
			...
			virtual bool onProductCreatedV(CGlobalPointLabelSet* vGlobalLabelSet, const std::vector<std::string>& vChildClassifierSigSet);
...
//			pcl::IndicesPtr m_pLastClassifierResult;
			...
			void __onClassifyDoneV() override { __ensembleResult(); }
			void __ensembleResult();
