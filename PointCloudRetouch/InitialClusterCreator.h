...
namespace hiveObliquePhotography
{
	namespace PointCloudRetouch
	{
		...
		public:
			...
			CPointCluster* createInitialCluster(const std::vector<pcl::index_t>& vUserMarkedRegion, double vHardness, double vRadius, EPointLabel vClusterLabel, const Eigen::Vector2f& vCenter, const Eigen::Matrix4f& vPvMatrix, const std::pair<double, double>& vWindowSize, const hiveConfig::CHiveConfig *vClusterConfig);
		...
		private:
			...
			void __generateHardness4EveryPoint(const std::vector<pcl::index_t>& vUserMarkedRegion, double vHardness, double vRadius, const Eigen::Vector2f& vCenter, const Eigen::Matrix4f& vPvMatrix, const std::pair<double, double>& vWindowSize, std::vector<double>& voPointHardnessSet);

			pcl::index_t __computeClusterCenter(const std::vector<pcl::index_t>& vUserMarkedRegion, const std::vector<double> vPointHardnessSet, const Eigen::Vector2f& vCenter, const Eigen::Matrix4f& vPvMatrix, const std::pair<double, double>& vWindowSize);
