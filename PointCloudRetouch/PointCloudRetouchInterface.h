...
namespace hiveObliquePhotography
{
	namespace PointCloudRetouch
	{
		...
		RETOUCH_DECLSPEC bool hivePreprocessSelected(std::vector<pcl::index_t>& vioSelected, const Eigen::Matrix4d& vPvMatrix, const std::function<float(Eigen::Vector2f)>& vSignedDistanceFunc, const Eigen::Vector3d& vViewPos);
