...
namespace hiveObliquePhotography
{
	namespace PointCloudRetouch
	{
		...
		public:
			...
			__forceinline Eigen::Vector4f getPositionAt(std::size_t vIndex) const;
			__forceinline Eigen::Vector4f getNormalAt(std::size_t vIndex) const;
			__forceinline Eigen::Vector4i getColorAt(std::size_t vIndex) const;
